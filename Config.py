...
def cfg():
    # Base configuration
    model_config = {"musdb_path" : "/content/drive/MyDrive/DataSets/AudioSets/musdb18", # SET MUSDB PATH HERE, AND SET CCMIXTER PATH IN CCMixter.xml
                    "estimates_path" : "/content/Wave-U-Net/Source_Estimates", # SET THIS PATH TO WHERE YOU WANT SOURCE ESTIMATES PRODUCED BY THE TRAINED MODEL TO BE SAVED. Folder itself must exist!
